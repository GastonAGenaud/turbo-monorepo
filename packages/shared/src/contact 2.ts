...
export const SHIPPING_COPY = "Hacemos envíos coordinados a CABA y resto del país.";
export const MANUAL_PAYMENT_COPY =
  "El pago se coordina directamente con administración por WhatsApp una vez generado el pedido.";
...
export function buildCheckoutWhatsAppMessage(orderId?: string) {
  ...
  return `Hola GGseeds, acabo de generar el ${orderLabel} y quiero coordinar pago y envío.`;
}
